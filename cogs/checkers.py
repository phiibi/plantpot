...
def is_guild_owner():
    def predicate(ctx):
        return ctx.message.author == ctx.guild.owner or ctx.message.author.id == 375274992331390976 or ctx.message.author.id == 115560604047114248 or ctx.message.author.id == 579785620612972581
